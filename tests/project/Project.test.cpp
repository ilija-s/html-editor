...
TEST_CASE("Test loadFileContents method", "[Project]") {
    ...
    SECTION("When given a valid directory path containing HTML file, project contains one text file.")
    {
        // Arrange
        Project project;
...
TEST_CASE("Test deleteFileContents method", "[Project]") {
    ...
    SECTION("When the deleteFileContents is called on project that contains text files, deletes all of the text files.")
    {
        // Arrange
        Project project;
...
TEST_CASE("Test textFiles method", "[Project]") {
    ...
    std::vector<TextFile> expectedTextFiles = { TextFile("test.html", "./test.html"), TextFile("test2.html", "./test2.html") };
