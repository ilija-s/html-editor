...
TEST_CASE("HTML parsing", "[parsing]") {
    SECTION("Tag parser parses opening tag with tag name only") {
        ...
        // Assert
        REQUIRE(*tokens1 == QVector<Token>{Token(TokenType::tag_open_bracket, 0, 1),
                                           Token(TokenType::tag_name, 1, 4),
                                           Token(TokenType::tag_close_bracket, 5, 1)});

        REQUIRE(*tokens2 == QVector<Token>{Token(TokenType::tag_open_bracket, 0, 1),
    ...
    SECTION("Tag parser parses closing tag with tag name only") {
        ...
        // Assert
        REQUIRE(*tokens1 == QVector<Token>{Token(TokenType::tag_open_bracket, 0, 2),
                                           Token(TokenType::tag_name, 2, 3),
                                           Token(TokenType::tag_close_bracket, 5, 1)});

        REQUIRE(*tokens2 == QVector<Token>{Token(TokenType::tag_open_bracket, 0, 2),
    ...
    SECTION("Tag parser parses multiple attributes") {
        ...
        REQUIRE(
            *tokens1 ==
            QVector<Token>{Token(TokenType::tag_open_bracket, 0, 1),
                           Token(TokenType::tag_name, 1, 3), Token(TokenType::attribute_name, 5, 4),
                           Token(TokenType::equals, 9, 1), Token(TokenType::attribute_value, 10, 5),
                           Token(TokenType::attribute_name, 16, 3), Token(TokenType::equals, 19, 1),
    ...
    SECTION("Tag parser parses opening and closing bracket with code in between") {
        ...
        REQUIRE(*tokens1 ==
                QVector<Token>{
                    Token(TokenType::tag_open_bracket, 0, 1), Token(TokenType::tag_name, 1, 1),
                    Token(TokenType::attribute_name, 3, 4), Token(TokenType::equals, 7, 1),
                    Token(TokenType::attribute_value, 8, 6),
                    Token(TokenType::tag_close_bracket, 14, 1),
                    Token(TokenType::tag_open_bracket, 19, 2), Token(TokenType::tag_name, 21, 1),
    ...
    SECTION("Tag parser parses nested tags") {
        ...
        REQUIRE(*tokens1 ==
                QVector<Token>{
                    Token(TokenType::tag_open_bracket, 0, 1), Token(TokenType::tag_name, 1, 3),
                    Token(TokenType::tag_close_bracket, 4, 1),
                    Token(TokenType::tag_open_bracket, 7, 1), Token(TokenType::tag_name, 8, 1),
                    Token(TokenType::tag_close_bracket, 9, 1),
                    Token(TokenType::tag_open_bracket, 14, 2), Token(TokenType::tag_name, 16, 1),
                    Token(TokenType::tag_close_bracket, 17, 1),
                    Token(TokenType::tag_open_bracket, 19, 2), Token(TokenType::tag_name, 21, 3),
